...
2.  **Write the Resume:** Construct a complete, professional resume using only the provided information.
    ...
    *   **Structure:** Organize the sections logically (e.g., Summary, Skills, Experience, Projects, Education, Achievements). If the user has no input for a section, you may omit it.
